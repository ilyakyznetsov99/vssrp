...
public class PacientSCardEntityController {
    ...
    public Iterable<PatientSCardEntity> getCabinetEntities() {
        return patientSCardEntityInterface.findAll();
    }
    @PostMapping("/add/pacientscard")
    public ResponseEntity<PatientSCardEntity> createCabinetEntity(@RequestBody PatientSCardEntity patientScard) {
    ...
    public ResponseEntity<PatientSCardEntity> getCabinetEntity(@PathVariable Integer id){
    ...
    public  ResponseEntity<String> updateCabinetEntity(@PathVariable Long id,@RequestBody PatientSCardEntity patientsCard){
